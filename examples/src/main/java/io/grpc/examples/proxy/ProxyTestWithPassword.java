 ...
 */
public class ProxyTestWithPassword {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Authenticator.setDefault(new Authenticator() {
      ...
      protected PasswordAuthentication getPasswordAuthentication() {
        ...
        System.out.println("password requested for: " + requestingURL);
        // toString() used here for brevity
        if (!requestingURL.toString().equals("https://127.0.0.1:3128")) {
          return null;
        }
        return new PasswordAuthentication("myuser1", "pass1".toCharArray());
      }
    });
